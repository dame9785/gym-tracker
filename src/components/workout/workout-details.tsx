...
export default function WorkoutDetails({ workout }: Props) {
  return (
    <section className="mx-auto w-full max-w-4xl">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    <span className="rounded-lg bg-white/5 px-3 py-1 text-xs font-medium text-gray-300">
                      {exercise.sets} set
                    </span>
      ...
      {/* Start workout */}
      <div className="mt-6 rounded-2xl border border-white/10 bg-gradient-to-r from-blue-500/10 to-purple-500/10 p-5">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="font-semibold text-white">Redo att börja?</h2>

            <p className="mt-1 text-sm text-gray-400">Starta passet och börja registrera dina set.</p>
          </div>
